      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-12">
        ...
        <div className="w-full max-w-4xl mb-12">
          ...
          <p className="mb-6 text-center text-sm text-slate-400">
            原価計算は1画面で切替：
            <span className="text-rose-300">D指令</span>
            {' / '}
            <span className="text-cyan-300">L指令</span>
            {' / '}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <Link href="/work-orders/cost">
              <div className="group relative h-32 cursor-pointer">
                ...
                <div className="relative h-full flex flex-col items-center justify-center p-6 space-y-1">
                  ...
                  <p className="text-[10px] text-rose-200/70">D / L / 製品パーツ</p>
                </div>
              </div>
            </Link>
            ...
            <Link href="/production-value">
              <div className="group relative h-32 cursor-pointer">
                <div className="absolute inset-0 bg-gradient-to-br from-teal-600/20 to-emerald-900/20 rounded-2xl border-2 border-teal-400 group-hover:border-teal-300 group-hover:shadow-[0_0_20px_rgba(45,212,191,0.5)] transition-all duration-300" />
                <div className="relative h-full flex flex-col items-center justify-center p-6 space-y-1">
                  <div className="text-4xl">💵</div>
                  <h3 className="text-base font-bold text-teal-300 group-hover:text-teal-200 transition">
                    生産額集計
                  </h3>
                  <p className="text-[10px] text-teal-200/70">月次・年次 / 印刷</p>
                </div>
              </div>
            </Link>
